...
* `FusionDirectory Core <https://github.com/fusiondirectory/fusiondirectory>`_
* `FusionDirectory plugins <https://github.com/fusiondirectory/fusiondirectory-plugins>`_
...
There are more and more unit tests in FusionDirectory; we use the `selenium unit tests framework <http://seleniumhq.org/>`_.
...
* `create a ticket <https://github.com/fusiondirectory/fusiondirectory/issues>`_
* fork, create a specific branch, and hack
* open a :abbr:`PR (Pull Request)`

Each bug will be fixed in a branch that came from the correct `fixes` branch. Once merged into the requested branch, developper must report the fixes in the `dev`; with a simple cherry-pick for simple cases, or opening another pull request if changes are huge.

Each feature will be hacked in a branch that came from `fixes`, and will be merged back to `dev`.
...
.. code-block:: bash
   ...
   $ git clone git@github.com:fusiondirectory/fusiondirectory.git

A directory named ``fusiondirectory`` will be created where you've issued the clone for the core of FusionDirectory and 

.. code-block:: bash

   $ git clone git@github.com:fusiondirectory/fusiondirectory-plugins.git

A directory named ``fusiondirectory-plugins`` will be created where you've issued the clone for FusionDirectory plugins.
...
.. code-block:: bash
   ...
   $ git remote add my_fork https://github.com/{your user name}/fusiondirectory.git
